...
\begin{minipage}{\textwidth}
    ...
    \begin{tabular}{ m{10mm} l }
        \mcqCheckbox{2}{0} & \verb|r'\d{3} \d{3}-\d{4}'| \\
        \mcqCheckbox{2}{1} & \verb|r'\d{10}'| \\
        \mcqCheckbox{2}{2} & \verb|r'\d* \d*-\d*'| \\
        \mcqCheckbox{2}{3} & \verb|r'\d+ \d+-\d+'| \\
    \end{tabular}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    PART1: \newline
    \begin{tabular}{ m{10mm} l }
        \mcqCheckbox{5}{PART1-0} & \verb|?| \\
        \mcqCheckbox{5}{PART1-1} & \verb|*| \\
        \mcqCheckbox{5}{PART1-2} & \verb|+| \\
    \end{tabular}
...
\begin{minipage}{\textwidth}
    ...
    \begin{tabular}{ m{10mm} l }
        \maCheckbox{6}{0} & Long Cat \\
        \maCheckbox{6}{1} & Loong Cat \\
        \maCheckbox{6}{2} & Looong Cat \\
        \maCheckbox{6}{3} & Loooong Cat \\
    \end{tabular}
\end{minipage}
